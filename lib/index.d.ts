 ...
 */
declare let connect: (props: import("./Connection").ConnectionParams) => Promise<import("./Connection").default>;
/**
 ...
 */
declare let createConnection: (props: import("./Connection").ConnectionParams) => Promise<import("./Connection").default>;
